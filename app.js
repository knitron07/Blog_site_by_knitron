...
app.get("/",function(req,res){
  Blog.find({},function(error,foundPosts){
    if(!error){
      if(foundPosts){
        res.render("home",{pageContent:homeStartingContent , postsOnhome:foundPosts});
      }
    }
  });
...
Blog.findOne({blogTitle:req.params.postName},function(error,foundblog){
  if(!error){
    if(foundblog){
      res.render("post",{postsOnpost:foundblog});
